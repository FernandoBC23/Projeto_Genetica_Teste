...
<style>
    ...
    .centered-title { text-align: center; font-size: 28px; font-weight: bold; margin-bottom: 5px; color: #DAEAB5; } 
    .custom-subheader {
        font-size: 16px;
        font-weight: bold;
        text-align: center;
...
st.info("ℹ️ Página em construção. Fique atento às próximas atualizações.")
